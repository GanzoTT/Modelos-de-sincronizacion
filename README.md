...
> En la simulación de ejemplo, **ambos modelos alcanzan sincronía** ( r \to 1 \).  
> Dependiendo de los parámetros **K**, **N**, y la dispersión de ( \omega ), pueden observarse transiciones **sincrónico ↔ incoherente**.
